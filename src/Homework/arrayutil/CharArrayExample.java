...
public class CharArrayExample {
    public static void main(String[] args) {
        ...
        System.out.print("middle two symbols : " + chars1[chars1.length / 2 - 1] + " " + chars1[chars1.length / 2]);
        System.out.println();
        ...
        char[] chars3 = {'j', 'a', 'v', 'a', 'l', 'o', 'l', 'y'};
            boolean b1 = chars3[chars3.length - 2] == 'l' && chars3[chars3.length - 1] == 'y' ? true : false;
